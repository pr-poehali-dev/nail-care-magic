...
const reviews = [
  ...
  { id: 4, name: 'Ольга Кузнецова', rating: 5, text: 'Невероятный дизайн ногтей! Всегда выхожу с идеальным маникюром. Спасибо мастерам!', avatar: '👩‍🦱' },
  { id: 5, name: 'Наталья Волкова', rating: 5, text: 'Хожу сюда уже полгода. Качество на высоте, цены адекватные. Всем советую!', avatar: '👩‍🦰' },
  { id: 6, name: 'Дарья Соколова', rating: 5, text: 'Лучший салон в районе! Удобная запись, приятные мастера и красивый результат.', avatar: '🧑‍🦳' },
];
